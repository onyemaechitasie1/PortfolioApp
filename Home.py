...
content1 = """Below yoou can find some of the Apps i have built on python feel free to contact me
    """
st.write(content1) #You can aswell use .info, it works with highlighted blue text
